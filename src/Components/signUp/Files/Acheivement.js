  ...
  return (
    <>
     ...
     <div class="text-[25px] lg:text-[32px] font-bold text-[#d9eee1]">Achievements</div>
        ...
        <div>
          <img src="https://www.w3schools.com/signup/coursecards.png" className="mt-10 pl-10 pr-10 w-auto"></img>
        </div>
        ...
        <div className="mt-10 pb-[10%] pl-5 pr-5">
          <img src="https://www.w3schools.com/signup/stars.svg" className="w-[500px] h-[138.23px]"></img>
        </div>
        <svg
