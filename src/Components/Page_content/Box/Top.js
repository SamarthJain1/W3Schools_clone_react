...
//                         <button className='flex justify-center items-center gap-1 text-[17px]'><ion-icon name="chevron-back-outline" style={{ fontSize: 20 }}></ion-icon> Home</button>
//                     </div>
//                     <div className='bg-[#04aa6d] p-3 rounded-lg'>
//                         <button className='flex justify-center items-center gap-1 text-[17px]'>Next <ion-icon name="chevron-forward-outline" style={{ fontSize: 20 }}></ion-icon></button>
//                     </div>
//                 </div>
//             </div>
//         </>
